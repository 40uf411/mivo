...
class MYSQL_AD extends AndromedaDriver
{
    ...
    public function connect($config = null)
    {
        ...
        $opt = isset($this->config['options'])? $this->config['options'] : [];
        try
        {
            $this->db = new PDO("mysql:host=" . $this->config['host'] . "; dbname=" . $this->config['name'], $this->config['user'], $this->config['pass'], $opt);
